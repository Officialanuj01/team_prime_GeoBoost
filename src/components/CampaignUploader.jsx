...
export default function CampaignUploader() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-darkNavy text-white">
      {/* Main content area */}
      <div className="flex flex-col grow justify-center items-center py-10 space-y-6">
        <h2 className="text-3xl font-extrabold text-blue-400">Upload Last Year's Report</h2>

        <div className="flex flex-col items-center w-full max-w-md bg-mediumNavy shadow-lg rounded-lg p-6 space-y-4">
          ...
          <label className="w-full">
            ...
            />
            <div
              className="w-full py-3 px-6 text-lg font-semibold text-white rounded-lg bg-blue-600 hover:bg-blue-700 cursor-pointer text-center transition-colors"
              onClick={() => document.querySelector('input[type="file"]').click()} // Trigger the file input
            >
              {uploadedReport ? uploadedReport.name : 'Choose File'}
            </div>
          </label>
      ...
      {/* Footer */}
      <footer className="w-full py-6 bg-mediumNavy text-gray-400 border-t border-gray-700">
        <div className="flex flex-col items-center sm:flex-row sm:justify-between px-4 md:px-6">
          <p className="text-xs">© 2024 Lodging Lift. All rights reserved.</p>
